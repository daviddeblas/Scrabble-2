...
describe('Individual functions', () => {
    ...
    it('onCommand should call processCommand, postCommand and EndGame if game needs to end', async () => {
        const endGameStub = stub(commandService as any, 'endGame').callsFake(() => {
            return;
        });
